...
- **[Admin dashboard](admin-dashboard.md)** — operator console
- **[Commercial license](commercial-license.md)** — AGPLv3 exception for Business subscribers

The server is **AGPLv3** — see [`server/LICENSE`](https://github.com/VoltiusApp/voltius/blob/main/server/LICENSE).
